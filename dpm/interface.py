...
_lib._dpm_init.argtypes    = [POINTER(MATRIX), POINTER(MATRIX), POINTER(VECTOR), c_uint, POINTER(VECTOR)]
...
def dpm_init(cov, cov_0, mu_0, n, pi):
     ...
     _lib._dpm_init(c_cov, c_cov_0, c_mu_0, n, c_pi)
